...
//	polyg[5]=(Point3(1, 1, 0));
	int res0 = inFacet_i(Point3(-1, 0, 0), polyg);
	int res1 = inFacet_i(Point3(2, -1.0001, 0), polyg);
	int res2 = inFacet_i(Point3(1, 0, 0), polyg);
	...
	//	int res2 = inPolygon_i(Point3(1, 0, 0), polygon, Point3(0, 0, 1));
		...
		int res0 = inFacet_i(Point3(2, 0.0001, 0.01), polyg);
		//int res1 = inPolygon_i2(Point3(2, -1.001, 0), polyg, Point3(0, 0, 1));
		//int res2 = inPolygon_i2(Point3(1, 0, 0), polyg, Point3(0, 0, 1));
		int res1 = inFacet_i(Point3(2, 0.0001, 0.01), polyg);
		int res2 = inFacet_i(Point3(2, 0.0001, 0.01), polyg);
